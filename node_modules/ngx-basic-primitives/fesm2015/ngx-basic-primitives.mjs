...
class Graphics {
    ...
    text(x, y, width, height, label, orientation, horizontalAlignment, verticalAlignment, attr) {
        ...
        this.activePlaceholder.activeLayer.labels.push(new Label(label, width, height, orientation, horizontalAlignment, verticalAlignment, Object.assign(Object.assign({}, attr), { top: y + "px", left: x + "px" })));
    }
    ;
    ...
    template(x, y, width, height, contentX, contentY, contentWidth, contentHeight, options, _hashCode, onRenderTemplate, uiHash, attr) {
        ...
        let style = Object.assign({ "width": templateWidth + "px", "height": templateHeight + "px", "top": top + "px", "left": left + "px" }, attr);
        var context = Object.assign(Object.assign(Object.assign({}, uiHash), options), { x: left, y: top, width: templateWidth, height: templateHeight });
...
class AbstractTemplate {
    constructor(templateType, options) {
        this.options = Object.assign(Object.assign({}, options), { templateType });
    }
    template() {
        return this.options;
    }
...
class CursorTemplate extends AbstractTemplate {
    constructor(options, templateConfig) {
        super("cursorTemplate", Object.assign(Object.assign({}, options), { templateConfig }));
    }
}
;
...
class DotHighlightTemplate extends AbstractTemplate {
    constructor(options, templateConfig) {
        super("dotHighlightTemplate", Object.assign(Object.assign({}, options), { templateConfig }));
    }
}
;
...
class HighlightTemplate extends AbstractTemplate {
    constructor(options, templateConfig) {
        super("highlightTemplate", Object.assign(Object.assign({}, options), { templateConfig }));
    }
}
;
...
class ItemTemplate extends AbstractTemplate {
    constructor(options, templateConfig) {
        super("itemTemplate", Object.assign(Object.assign({}, options), { templateConfig }));
    }
}
;
...
class LevelTitleTemplate extends AbstractTemplate {
    constructor(options, orientation) {
        ...
        super("levelTitleTemplate", Object.assign(Object.assign({}, options), { orientation,
...
class UserTemplate extends AbstractTemplate {
    constructor(options, itemTemplate, onRender) {
        super("dummyTemplate", Object.assign(Object.assign({}, options), { itemTemplate }));
        this.render = onRender;
    }
}
;
...
class RotatedText {
    ...
    ngOnChanges() {
        ...
        this.tableStyle = Object.assign(Object.assign({}, style), { borderCollapse: "collapse" });
        this.divStyle = style;
    }
...
class BaseDiagramComponent {
    ...
    getOptions() {
        ...
        const effectiveTemplates = templates.map(template => {
            ...
            return Object.assign(Object.assign({}, template), { onButtonsRender: !buttonsTemplate ? null : () => buttonsTemplate });
        });
        const { highlightItem, cursorItem, selectedItems } = this.state;
        return Object.assign(Object.assign({}, config), { templates: effectiveTemplates, highlightItem,
            cursorItem,
            selectedItems, onItemRender: this.onItemRender.bind(this), onCursorRender: this.onCursorRender.bind(this), onHighlightRender: this.onHighlightRender.bind(this), onGroupTitleRender: !config.groupTitleTemplate ? null : () => config.groupTitleTemplate, onLevelBackgroundRender: !config.levelBackgroundTemplate ? null : () => config.levelBackgroundTemplate, onLevelTitleRender: !config.levelTitleTemplate ? null : () => config.levelTitleTemplate, onButtonsRender: !config.buttonsTemplate ? null : () => config.buttonsTemplate });
    }
    getGraphics() {
    ...
    render() {
        ...
        if (framePlaceholder) {
            this.framePlaceholderStyle = Object.assign(Object.assign({}, (framePlaceholder.rect.getCSS())), { "transform": scaleText, "msTransform": scaleText, "WebkitTransform": scaleText, "OTransform": scaleText, "MozTransform": scaleText });
        }
        this.titlesMousePanelStyle = Object.assign({}, titlesMousePanelRect.getCSS());
        if (titlesPlaceholder) {
            this.titlesPlaceholderStyle = Object.assign(Object.assign({}, (titlesPlaceholder.rect.getCSS())), { "transformOrigin": "0 0", "transform": scaleText, "msTransform": scaleText, "WebkitTransform": scaleText, "OTransform": scaleText, "MozTransform": scaleText });
        }
        this.scrollPanelStyle = Object.assign(Object.assign({}, (scrollPanelRect.getCSS())), { border: (scrollPanelRect.x > 0 ? "1px dotted #dddddd" : "") });
        this.mousePanelStyle = Object.assign({}, (mousePanelSize.getCSS()));
        this.placeholderStyle = Object.assign(Object.assign({}, (placeholder.rect.getCSS())), { "transform": scaleText, "msTransform": scaleText, "WebkitTransform": scaleText, "OTransform": scaleText, "MozTransform": scaleText });
...
class OrgDiagramComponent extends BaseDiagramComponent {
    ...
    ngOnChanges(changes) {
        ...
        this.state = Object.assign(Object.assign({}, this.state), { config,
            highlightItem,
            cursorItem,
            selectedItems, centerOnCursor: this.centerOnCursor });
        this.render();
    }
    _onHighlightChanging(event, itemId, newItemId) {
        var newEvent = new OrgEventArgs(Object.assign(Object.assign({}, (this.getEventArgs(itemId, newItemId))), { event }));
...
class FamDiagramComponent extends BaseDiagramComponent {
    ...
    _onHighlightChanging(event, itemId, newItemId) {
        var newEvent = new FamEventArgs(Object.assign(Object.assign({}, (this.getEventArgs(itemId, newItemId))), { event }));
        this.onHighlightChanging.emit(newEvent);
        return newEvent;
    }
    ;
