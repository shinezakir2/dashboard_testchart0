 ...
 */
export declare enum ChildrenPlacementType {
    /**
 ...
 */
export declare enum ConnectorLabelPlacementType {
    From = 0,
    Between = 1,
    To = 2
}
 ...
 */
export declare enum ConnectorPlacementType {
    /**
 ...
 */
export declare enum ConnectorShapeType {
    /**
...
export declare enum ConnectorStyleType {
    Extra = 0,
    Regular = 1,
    Highlight = 2
}
 ...
 * @enum {NavigationMode}
 */
export declare enum NeighboursSelectionMode {
    /**
 ...
 * @enum {PageFitMode}
 */
export declare enum PageFitMode {
    /**
 ...
 */
export declare enum SelectionPathMode {
    /**
     * No selection path
     */
    None = 0,
 ...
 * @enum {ZOrderType}
 */
export declare enum ZOrderType {
    /**
